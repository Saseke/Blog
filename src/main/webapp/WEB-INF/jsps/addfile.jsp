        ...
        <div class="row">
            ...
            <div class="col-md-8 ">
                <div class="blog-post">
                    ...
                    <form action="${pageContext.request.contextPath}/opeate/addFile.html" method="post">

                        文章标题 <input  type="text" id="textTitle" required="required"  name="title" style="width: 300px" height="200px"/><br/>
                        文章正文 <textarea rows="30" cols="50" name="content"></textarea>
